...
import com.pandey.shubham.githubtrends.base.v2.IBaseViewModel
...
class NewsListViewModel : IBaseViewModel() {

    private val networkService = GApplication.newsApiService
